...
enum ap_message : uint8_t {
    ...
    MSG_ABZ_IS_SPRAYING,
    MSG_ABZ_START_MISSION,
    MSG_ABZ_PLAN_PROGRESS,
    MSG_ABZ_IS_RETURN_POINT,
    MSG_ABZ_UPDATE_MISSION,
    MSG_ABZ_IS_MISSION_IN_PROGRESS,
    MSG_ABZ_EMPTY_TANK_ACTION,
    MSG_ABZ_RETURNING_POINT_COR,
    MSG_ABZ_EMPTY_POINT_COR,
    MSG_ABZ_MISSION_PARAMS,
